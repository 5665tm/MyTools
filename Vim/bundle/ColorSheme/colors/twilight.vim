...
set cul
hi IndentGuidesOdd  guifg=#7386a5 gui=NONE guibg=#000000   ctermbg=3
hi IndentGuidesEven guifg=#afd787 gui=NONE guibg=#404040 ctermbg=4
hi Cursor  guifg=#000000 guibg=#7386a5 ctermbg=248 gui=NONE cterm=NONE
hi Visual  guifg=NONE guibg=#444444 ctermbg=238 gui=bold,italic,underline cterm=NONE
...
hi MatchParen  guifg=#7386a5 ctermfg=179 guibg=NONE gui=bold,italic,underline cterm=NONE
...
hi TabLine  guifg=#7386a5 ctermfg=15 guibg=#8f9dba ctermbg=237 gui=NONE cterm=NONE
hi TabLineFill guifg=#7386a5 ctermfg=15 guibg=#8f9dba ctermbg=237 gui=NONE cterm=NONE
hi TabLineSel guifg=#7386a5 ctermfg=15 guibg=#8f9dba ctermbg=237 gui=NONE cterm=NONE
hi Pmenu  guifg=#9b703f ctermfg=95 guibg=NONE gui=bold cterm=NONE
hi PmenuSel  guifg=NONE guibg=#3c4043 ctermbg=238 gui=NONE cterm=NONE
hi IncSearch  guifg=#7386a5 guibg=NONE ctermbg=237 gui=underline,bold cterm=NONE
hi Search  guifg=#7386a5 guibg=#303030 ctermbg=248 gui=NONE cterm=NONE
hi Directory  guifg=#cf6a4c ctermfg=167 guibg=NONE gui=NONE cterm=NONE
hi Folded  guifg=#000000 ctermfg=59 guibg=#777777 ctermbg=233 gui=NONE cterm=NONE

hi Normal  guifg=#f8f8f8 ctermfg=15 guibg=#000000 ctermbg=233 gui=NONE cterm=NONE
...
hi Label  guifg=#afd787 ctermfg=107 guibg=NONE gui=NONE cterm=NONE
...
hi SpecialKey  guifg=#7386a5 ctermfg=239 guibg=#141414 ctermbg=234 gui=bold cterm=NONE
...
hi String  guifg=#afd787 ctermfg=107 guibg=NONE gui=NONE cterm=NONE
...
hi rubyStringDelimiter  guifg=#7386a5 ctermfg=107 guibg=NONE gui=NONE cterm=NONE
...
hi yamlDocumentHeader  guifg=#7386a5 ctermfg=107 guibg=NONE gui=NONE cterm=NONE
