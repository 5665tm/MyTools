" Color palette
let s:gui_dark_gray = '#999999'
let s:cterm_dark_gray = 236
let s:gui_med_gray_hi = '#333333'
let s:cterm_med_gray_hi = 238
let s:gui_med_gray_lo = '#888888'
let s:cterm_med_gray_lo = 237
let s:gui_light_gray = '#444444'
...
" Normal mode
let s:N1    = [s:gui_med_gray_hi, s:gui_green, s:cterm_dark_gray, s:cterm_green]
...
let g:airline#themes#bubblegum#replace = {
      \ 'mode':           [s:gui_med_gray_hi, s:gui_red, s:cterm_dark_gray, s:cterm_red, ''],
...
" Visual mode
let s:V1 = [s:gui_med_gray_hi, s:gui_pink, s:cterm_dark_gray, s:cterm_pink]
